...
const LAYERS = [
    ...
    { enabled: true, particleCount: 9, baseSize: 0.5, sizeRandomness: 1.5, baseOpacity: 10, opacityRandomness: 0.2, rotationSpeed: -0.002, turbulence: 0.4, scatterSize: 0.6, collisionStrength: 0.2, colorStart: '#0000FF', colorEnd: '#FFA500', glow: true, blending: 'additive', brightness: 5, shape: 'circle', uniformity: 0, ripple: false, rippleSpeed: 1.0 },
    ...
    { enabled: true, particleCount: 27, baseSize: 0.3, sizeRandomness: 1, baseOpacity: 2.0, opacityRandomness: 1, speed: 0.003, outwardSpeed: 0.7, color: '#00ffe5', binaryColor0: '#ff9900', binaryColor1: '#00ffff', blending: 'additive', brightness: 5.0, shape: 'binary', uniformity: 0.3, ripple: true, rippleSpeed: 0.3 }
];
